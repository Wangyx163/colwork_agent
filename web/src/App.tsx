...
/** The workbench issues a session token and stores it here; the Observatory
 *  reuses it rather than minting an identity of its own, so the same
 *  coordinator check applies. */
